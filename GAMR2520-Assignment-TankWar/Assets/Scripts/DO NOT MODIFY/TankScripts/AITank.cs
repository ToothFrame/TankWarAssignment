...
public abstract class AITank : MonoBehaviour
{
    ...
    /// </summary>
    protected void FaceTurretToPoint(GameObject pointInWorld)
    {
    ...
    /// </summary>
    protected Dictionary<GameObject, float> TanksFound
    {
        get
        {
            return targetsFound;
    ...
    /// </summary>
    protected Dictionary<GameObject, float> ConsumablesFound
    {
        get
        {
    ...
    /// </summary>
    protected Dictionary<GameObject, float> BasesFound
    {
        get
        {
            return basesFound;
